  ...
  return (
    <div>
      <div className="row">
        <div className="col-8">
          <div className="card">
            <div className="card-header bg-success">Employee List</div>
        ...
        <div className="col-4">
          <div className="card">
            <div className="card-header bg-success">New Employee</div>
            <div className="card-body">
              <div className="row">
                <div className="col-6">
                  <label>Name</label>
                  <input
                    type="text"
                    value={employeeObj.empName}
                    onChange={(event) => {
                      changeFormValue(event, "empName");
                    }}
                ...
                <div className="col-6">
                  ...
                  <input
                    type="text"
                    value={employeeObj.empContactNo}
                    onChange={(event) => {
              ...
              <div className="row">
                <div className="col-6">
                  ...
                  <input
                    type="text"
                    value={employeeObj.empAltContactNo}
                    onChange={(event) => {
                      changeFormValue(event, "empAltContactNo");
                    }}
                    className="form-control"
                  />
                </div>
                <div className="col-6">
                  ...
                  <input
                    type="text"
                    value={employeeObj.empEmail}
                    onChange={(event) => {
                      changeFormValue(event, "empEmail");
                    }}
                    className="form-control"
                  />
                </div>
              ...
              <div className="row">
                <div className="col-6">
                  ...
                  <textarea
                    className="form-control"
                    value={employeeObj.addressLine1}
                    onChange={(event) => {
                      changeFormValue(event, "addressLine1");
                    }}
                  ></textarea>
                </div>
                <div className="col-6">
                  ...
                  <textarea
                    className="form-control"
                    value={employeeObj.addressLine2}
                    onChange={(event) => {
                      changeFormValue(event, "addressLine2");
                    }}
                  ></textarea>
                </div>
              </div>
              <div className="row">
                <div className="col-6">
                  ...
                  <input
                    ...
                    className="form-control"
                    onChange={(event) => {
                      changeFormValue(event, "bankName");
                    }}
                  />
                </div>
                <div className="col-6">
                  ...
                  <input
                    ...
                    className="form-control"
                    onChange={(event) => {
                      changeFormValue(event, "accountNo");
                    }}
                  />
                </div>
              </div>
              <div className="row">
                ...
                <div className="col-6">
                  ...
                  <input
                    type="text"
                    value={employeeObj.bankBranch}
                    className="form-control"
                    onChange={(event) => {
                      changeFormValue(event, "bankBranch");
                    }}
                  />
                </div>
              </div>
